...
int endcolor = -131072;
		...
		//10. if the mouse is on the end color
				if (mouseColor == endcolor) {
					...
					JOptionPane.showMessageDialog(null, "You somehow won!");
				}
...
showScaryImage("picture for L takers.jpg");
	}
